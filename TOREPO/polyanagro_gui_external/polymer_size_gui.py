...
def show_output_files_content(output_file_paths, log_filename):
    # Verificar si el fichero de registro está presente en la lista de archivos de salida
    ...
    ***********************************************************************
    ...
    with st.expander("OPTIONS"):
        ...
        end_to_end_distances = st.file_uploader("Select a file for calculate the end to end distances "
                                      "(The format of the files must be a line for chain: ich ihead itail.The index must start in zero.)",
            ...
            if traj_files and topo_file is not None:
                with st.spinner("Running Polymer Size. Please wait..."):
                    ...
                    with tempfile.TemporaryDirectory() as temp_dir:
                        ...
                        # If end_to_end_distances file or end_to_end_acf is activated, include these aditional files
                        if end_to_end_distances_path:
                            output_files.extend([
                                "Ree2Rg2.dat",  #   Usually not file found
                                "Ree.dat"
                            ])
                        ...
                        if compressed_file_name:
                            ...
                            # Generar enlace de descarga solo si se ha ingresado un nombre
                            ...
                            # Mostrar nombres de archivos de salida solo si se ha ingresado un nombre
